...
for i in range(100000):
    ...
    aa1 = 6500
    aa2=random.random()/2
    aa3=random.random()*90
    aa4=random.random()*360
    ...
    aaa1 = 6500
    aaa2=random.random()/2
    aaa3=random.random()*90
    aaa4=random.random()*360
    aaa5=random.random()*360
    aaa6=random.random()*360
    ...
    if chainResults3.DataSets.Count != 0:
        ...
        coverage3 = 0 
    myFo.write("%.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.2f %.3f %.3f %.3f\n" % (a2,a3,a4,a5,aa2,aa3,aa4,aa5,aa6,aaa2,aaa3,aaa4,aaa5,aaa6,coverage1,coverage2,coverage3))
