...
# 初始化参数
banchangzhou = [4737, 4937, 5137, 5337, 5537, 5737, 5937, 6137, 6337, 6537, 6737]           # 3000-5000
...
xiangwei = [0, 15, 30, 45, 60, 75, 90, 105, 120, 135, 150, 165, 180]                # 0-360
            ...
            for a4 in jindidian:
                ...
                for a5 in shengjiaodian:
                    ...
                    if chainResults3.DataSets.Count != 0:
                        ...
                        coverage3 = 0    
                    myFo.write("%d %.1f %d %d %d %.1f %.1f %.1f\n" % (a1,a2,a3,a4,a5,coverage1,coverage2,coverage3))
        endTime = time.time()
