...
def import_data():
    ...
    for file in files:
        ...
        for line in fo:
            ...
            line_data[2]=(line_data[2]+10)/70
            line_data[7]=(line_data[7]+10)/70
            line_data[3]=(line_data[3]+60)/180
            line_data[8]=(line_data[8]+60)/180
            line_data[4]=(line_data[4]+20)/80
            line_data[9]=(line_data[9]+20)/80
            line_data[10]=(line_data[10]+30)/270

            # line_data[11]=line_data[11]+line_data[12]+line_data[13]
            # line_data[11]=line_data[11]/10
            # line_data[12]=line_data[12]/10
            # line_data[13]=line_data[13]/10

            train.append(line_data[0 : 11])
            label.append(line_data[11 : 14])
        fo.close()
...
# nerual network
model = Sequential()
model.add(Dense(units=32, activation='relu', input_dim=11))#kernel_regularizer=regularizers.l2(0.1)
